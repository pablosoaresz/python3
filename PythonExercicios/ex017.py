...
print('Usando a importação do método "hypot" do módulo "math" a hipotenusa vai medir {:.2f}.'.format(hipot))
print('Usando o método matemático, a hipotenusa irá medir {:.2f}.'.format(hipote))